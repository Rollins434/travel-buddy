...
$query1 = "Select * from users where role='customer'";
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        $query_2 = "Select * from users where role = 'hotel'";
                        $res_2 = mysqli_query($con,$query_2);
                        while($result = mysqli_fetch_array($res_2))
                        { 
                        echo "<tr>
                        <td>
                        ".$result['id']."
